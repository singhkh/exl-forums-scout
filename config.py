...
class ScraperConfig:
    """Configuration manager for the AEM Forms scraper"""
    ...
    def get_manager(self, manager_id):
        ...
        if manager_key in self.managers:
            ...
            # Ensure slack handle has @ prefix
            if 'slack' in manager_info and not manager_info['slack'].startswith('@'):
                manager_info['slack'] = f"@{manager_info['slack']}"
